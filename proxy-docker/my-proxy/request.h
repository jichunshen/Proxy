...
public:
    ...
    void parse(std::string buff) {
        ...
        std::size_t pos2 = buff.find(' ', pos + 2);
        ...
        if (pos3 != std::string::npos && pos3 < pos2) {//has port
            ...
            if(buff.find("https")!=std::string::npos){
                port = 443;
            }
            else{
                port = 80;
        ...
        // if (pos3 != std::string::npos) {
            // std::cout << "find Proxy-connect" << std::endl;
        ...
        // pos = return_buff.find("keep-alive");
        // if (pos != std::string::npos) {
            // return_buff.replace(pos, 10, "close");
        // }
        // return return_buff;
    }
    void display(){
        std::cout<<"I am request"<<std::endl;
